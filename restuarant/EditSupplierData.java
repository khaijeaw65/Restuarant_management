...
public class EditSupplierData extends javax.swing.JDialog {

    public static final int RET_CANCEL = 0;
    public static final int RET_OK = 1;
    private String [] data;

    public EditSupplierData(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public EditSupplierData(java.awt.Frame parent, boolean modal, String[] data) {
        super(parent, modal);
        initComponents();
        this.data = data;
        fillData();
    ...
    private void fillData(){
        company_field.setText(this.data[1]);
        name_field.setText(this.data[2]);
        tel_field.setText(this.data[4]);
        address_field.setText(this.data[3]);
    }
    
    private boolean checkInput(){
        boolean isValid = false;
        if (!company_field.getText().equals("") && !name_field.getText().equals("") && tel_field.getText().matches("[0-9]+") && !tel_field.getText().equals("") && !address_field.getText().equals(""))
            isValid = true;
    ...
    private void update(){
        ...
        dc.updateSupplierData(id, company, name, tel, address);        
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditSupplierData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditSupplierData dialog = new EditSupplierData(new javax.swing.JFrame(), true);
