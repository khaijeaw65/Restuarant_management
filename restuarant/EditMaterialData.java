...
public class EditMaterialData extends javax.swing.JDialog {

    public static final int RET_CANCEL = 0;
    public static final int RET_OK = 1;
    private String[] data;

    public EditMaterialData(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public EditMaterialData(java.awt.Frame parent, boolean modal, String[] data) {
        super(parent, modal);
        initComponents();
        this.data = data;
    ...
    private boolean validatedInput() {
        ...
        if (!name.isEmpty() && !unit.isEmpty() && !price.isEmpty() && !detail.isEmpty() && !price.matches("\\d*(\\.\\d{0,2})?")) {
            isValid = true;
        }
    ...
    private void setTextField() {
        ...
        materialNameField.setText(data[1]);
        unitField.setText(data[3]);
        priceField.setText(data[4]);
        detailField.setText(data[5]);
    }
    ...
    private void updateData() {
        ...
        dc.updateMaterialData(id, name, price, unit, detail);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditMaterialData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditMaterialData dialog = new EditMaterialData(new javax.swing.JFrame(), true);
